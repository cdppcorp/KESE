...
主要情報通信基盤施設（CII）の脆弱性分析評価、AIセキュリティ評価、ロボットセキュリティ点検、宇宙セキュリティ点検、セキュアコーディングガイド、ゼロトラストセキュリティ評価のためのClaude Codeスキルプラグインです。
...
| スキル | 説明 |
|--------|------|
| `/kesekit-start` | セキュリティ脆弱性の総合評価を実行（CII 560+ / AIセキュリティ / ロボットセキュリティ / 宇宙セキュリティ / セキュアコーディング / ゼロトラスト） |
| `/kesekit-check` | デプロイ前のセキュリティコンプライアンスチェックリスト（CII / AI / ロボット / 宇宙 / セキュアコーディング / ゼロトラスト） |
| `/kesekit-fix` | ハードニングスクリプトおよびセキュリティ修正の自動生成（CII / AI / ロボット / 宇宙 / セキュアコーディング / ゼロトラスト） |
| `/kesekit-guide` | AIツール向けセキュアコーディングプロンプトの生成（CII / AI / ロボット / 宇宙 / JS・Python・汎用 / ゼロトラスト） |
