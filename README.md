...
v3.0 unified all skills into a single `kesekit` namespace. If you were using v2.x or earlier, note the following command changes:
...
> **Note:** The old `/start`, `/check`, `/fix`, `/guide` commands no longer work. Use the `/kesekit:*` (colon) format with the namespace prefix.
